...
read -p "Enter your bot token:5735993347:AAEayWaAKCSCKzBkZJcvZVJgfcy_ICqCFwc" token
read -p "Enter your chat ID:6005877877" id
sed -i "s/const token = '5735993347:AAEayWaAKCSCKzBkZJcvZVJgfcy_ICqCFwc'/const token = '$token'/g" index.js
sed -i "s/const id = '6005877877'/const id = '$id'/g" index.js
